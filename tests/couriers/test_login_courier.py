...
class TestLoginCourier:
    ...
    def test_courier_login_success(self, courier_client):
        result = data.RESP_LOGIN_COURIER_SUCCESS
        resp = courier_client.courier_login(ec['login'],  ec['password'])
    ...
    def test_courier_login_unsuccess(self, courier_client, login, password, result):
        resp = courier_client.courier_login(login, password)
